import { r as registerInstance, h, e as Host } from './index-8c7f86fe.js';
...
let AppHome = class {
  ...
  render() {
    return (h(Host, null, h("my-component", { first: "MY-COMPONENT" }), h("prefix-my-component", { first: "PREFIX-MY-COMPONENT" })));
  }
};
