import { r as registerInstance, h, e as Host } from './index-76361fa5.js';
...
let AppHome = class {
  ...
  render() {
    return (h(Host, null, h("my-component", { first: "MY-COMPONENT" }, "\uD83D\uDC7B"), h("wmlist-my-component", { first: "PREFIX-MY-COMPONENT" }, "\uD83E\uDD13"), h("stencil-route-link", { url: "/profile/stencil" }, h("button", null, "Profile page"))));
  }
};
