import { B as BUILD, N as NAMESPACE, E as Env, r as registerInstance$1, h as h$2, e as Host$1 } from './index-9d0a929f.js';
...
const defineCustomElement$3 = (Cstr, compactMeta) => {
...
let MyComponent = class extends H {
  constructor() {
    super();
    this.__registerHost();
    this.__attachShadow();
...
MyComponent = /*@__PURE__*/ proxyCustomElement(MyComponent, [1, "lib-component", {
    "first": [1],
    "middle": [1],
    "last": [1]
  }]);
function defineCustomElement$1$1() {
  ...
  const components = ["lib-component"];
...
let MyChild = class extends H {
  ...
  render() {
    return (h$1(Host, null, "... and this is my child!"));
  }
  static get style() { return myChildCss; }
};
MyChild = /*@__PURE__*/ proxyCustomElement(MyChild, [1, "lib-child"]);
function defineCustomElement$1() {
  if (typeof customElements === "undefined") {
    return;
  }
  const components = ["lib-child"];
  components.forEach(tagName => { switch (tagName) {
    case "lib-child":
      if (!customElements.get(tagName)) {
...
customElements.define('wmlist-component', LibComponent);
customElements.define('wmlist-child', LibChild);
let AppHome = class {
  constructor(hostRef) {
    registerInstance$1(this, hostRef);
  }
  render() {
    return (h$2(Host$1, null, h$2("__prefix__-component", { first: "MY-COMPONENT" }, "\uD83D\uDC7B"), h$2("wmlist-component", { first: "PREFIX-MY-COMPONENT" }, "\uD83E\uDD13"), h$2("stencil-route-link", { url: "/profile/stencil" }, h$2("button", null, "Profile page"))));
  }
};
